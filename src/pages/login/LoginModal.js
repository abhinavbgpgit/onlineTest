          ...
          <div class="cursor-default select-none absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-full max-w-2xl max-h-full bg-red">
            <div className="flex justify-center">
              ...
              >
                ...
                <button className="bg-[#50A150] pt-2 pb-3 px-5 text-white font-sans tracking-tight mb-3 rounded-[30px] translate-x-[60%]" style={{"box-shadow": "rgba(0, 0, 0, 0.35) 0px 5px 15px]"}}>Create Account</button>
